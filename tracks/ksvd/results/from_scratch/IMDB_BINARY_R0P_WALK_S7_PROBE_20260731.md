...
> 日期：2026-07-31
>
> 探索性结论：**PASS_R0P_RAW_WALK_SUBSTRATE_AND_SIGNAL**
...
- patch edge mean：16.0831。
- tree fraction：0.0000。
- clique fraction：0.3359。
- missing-at-most-one-edge fraction：0.3401。
- WALK unique vectors：1446。
- rooted-canonical unique signatures：300。
- canonical effective signature count：18.9290。
- dominant canonical signature mass：0.3359。
- within-graph canonical unique fraction min/median/mean：0.0417/0.5000/0.4608。

Patch edge-count histogram：

```text
{"10": 1066, "11": 315, "12": 2119, "13": 3222, "14": 339, "15": 657, "16": 2385, "17": 667, "18": 255, "19": 186, "20": 74, "21": 5887, "6": 0, "7": 2, "8": 79, "9": 273}
```
...
| walk_mean_std | 0.6187 | 0.0095 | [0.6310, 0.6080, 0.6170] |
| canonical_mean_std | 0.6297 | 0.0065 | [0.6220, 0.6380, 0.6290] |
| edge_count_histogram | 0.6480 | 0.0057 | [0.6560, 0.6440, 0.6440] |
| graph_stats_plus_walk_mean_std | 0.6957 | 0.0125 | [0.7050, 0.6780, 0.7040] |
| graph_stats_plus_canonical_mean_std | 0.6913 | 0.0024 | [0.6930, 0.6930, 0.6880] |
| graph_stats_plus_edge_count_histogram | 0.6917 | 0.0058 | [0.6840, 0.6930, 0.6980] |
| walk_label_shuffle | 0.5044 | 0.0152 | [0.4990, 0.5251, 0.4891] |
...
- [x] `canonical_effective_signature_count_ge_10`
...
下一步：Freeze raw-stratified and exact-isomorphism-grouped folds, then run a paired single-INIT versus FINAL held-out reconstruction audit. Keep cleaned as sensitivity only.

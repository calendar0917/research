# luyin16-molhiv-exact-topology-conditional-chemistry-normalized-v1
...
| `s_wl_conditional` | 0.700745 | 0.060843 |
| `s_wl_conditional_mean` | 0.698254 | 0.056684 |
...
| `s_hybrid_conditional_mean` | 0.697375 | 0.061561 |
...
| `s_wl_conditional_shuffled_0` | 0.718095 | 0.057004 |
| `s_wl_conditional_mean_shuffled_0` | 0.693493 | 0.031440 |
| `s_hybrid_conditional_shuffled_0` | 0.711141 | 0.059535 |
| `s_hybrid_conditional_mean_shuffled_0` | 0.687747 | 0.049772 |
...
| `s_wl_conditional_shuffled_1` | 0.681225 | 0.033039 |
| `s_wl_conditional_mean_shuffled_1` | 0.654342 | 0.024441 |
| `s_hybrid_conditional_shuffled_1` | 0.666063 | 0.025048 |
| `s_hybrid_conditional_mean_shuffled_1` | 0.659214 | 0.031462 |
...
- `wl_conditional_vs_wl_unbound`: -0.013773, wins 0/3 — **FAIL**
- `wl_conditional_mean_vs_wl_unbound`: -0.016264, wins 0/3 — **FAIL**
- `hybrid_conditional_vs_hybrid_unbound`: +0.006648, wins 2/3 — **PASS**
- `hybrid_conditional_mean_vs_hybrid_unbound`: +0.001968, wins 2/3 — **FAIL**
...
- `wl_conditional_pairing_true_vs_shuffle`: +0.001085, wins 2/3 — **FAIL**
- `wl_conditional_mean_pairing_true_vs_shuffle`: +0.024337, wins 2/3 — **PASS**
- `hybrid_conditional_pairing_true_vs_shuffle`: +0.013453, wins 2/3 — **PASS**
- `hybrid_conditional_mean_pairing_true_vs_shuffle`: +0.023894, wins 2/3 — **PASS**

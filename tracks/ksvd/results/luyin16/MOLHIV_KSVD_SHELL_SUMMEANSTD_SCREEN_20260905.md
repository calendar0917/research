# luyin16-molhiv-ksvd-shell-summeanstd-screen-v1
...
- pair relation: `42D`; readout: `sum_mean_std`
- message passing: `False`; attention: `False`

| head | valid ROC-AUC | test ROC-AUC after train+valid refit | selected epoch |
|---|---:|---:|---:|
| `single_mlp` | 0.765058 | 0.796540 | 4 |

- trainable parameters: `95185`
- total parameters including frozen dictionary: `145937`

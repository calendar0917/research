...
def setup_env(methods=None):
    ...
    pip_install("numpy<2", "setuptools<80",
                ...
                "hydra-core", "omegaconf", "tqdm", "scikit-learn", timeout=1800)
...
def run_gps(dataset, seed, smoke, max_epochs):
    ...
    rc, secs, meta = run(cmd, repo, log, label=f"gps/{dataset}/seed={seed}")
    if rc != 0:
...
def main():
    global RUN_ID, LIVE_LOG, RUNTIME_INFO
